...
#标准双接口 
def create_trade_by_buyer (tn, subject, body, price, quantity):
    params = {}
    # 基本参数
...
def send_goods_confirm_by_platform (tn):
    ...
    # 业务参数
    params['trade_no']  = tn
    params['logistics_name'] = u'MOECN.NET'   # 物流公司名称
    params['transport_type'] = u'DIRECT'
...
def notify_verify(post):
    ...
    if settings.ALIPAY_TRANSPORT == 'https':
        ...
        gateway = 'http://mapi.alipay.com/gateway.do'
